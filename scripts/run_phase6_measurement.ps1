...
param(
    [Parameter(Mandatory)]
    [ValidateSet('configs/phase6-iq2-comparison.json', 'configs/phase6-q2-comparison.json')]
    [string]$Config,
...
if ($LASTEXITCODE -ne 0) { throw 'Phase 6 measurement did not complete successfully.' }
