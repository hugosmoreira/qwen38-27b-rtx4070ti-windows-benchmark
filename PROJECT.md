...
- Phase 10 passed its strict local `v0.1.0` gate and was published to `hugosmoreira/qwen38-27b-rtx4070ti-windows-benchmark` on 2026-08-16. After Phase 13 completed, final GitHub Release `v0.1.0` was published at commit `d1a6056` on 2026-08-17; the Python 3.11/3.14 Windows matrix passes.
- Phase 11 completed on 2026-08-16. The evidence-linked report was published by `Hugosmr` as `unsloth/Qwen3.8-27B-GGUF` Community Discussion `#65`; the rendered post preserves all 25 original GitHub evidence links and the study limitations. A Phase 13 follow-up comment linking release `v0.1.0` and the IQ4_XS evidence was published on 2026-08-17.
